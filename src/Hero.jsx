        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12 py-20">
          ...
          <div className="text-center lg:text-left max-w-2xl">
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold text-white mb-4">
              Hi, I'm <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 to-blue-500">Abhijit Rabidas</span>
            </h1>
            ...
            <div className="h-16 sm:h-20 mb-6">
              <p className="text-xl sm:text-2xl md:text-3xl text-gray-300 font-medium">
                ...
                <span className="text-emerald-400">
                  {dynamicText}
                  <span className={`inline-block w-1 h-8 bg-emerald-400 ml-1 ${showCursor ? 'opacity-100' : 'opacity-0'}`}></span>
                </span>
              </p>
            </div>
            ...
            <p className="text-lg text-gray-400 mb-8 max-w-lg mx-auto lg:mx-0">
              ...
              Currently mastering computer applications while building innovative projects.
            </p>
            ...
            <div className="flex justify-center lg:justify-start gap-4 mt-8">
              {[
                { icon: 'linkedin-in', url: 'https://www.linkedin.com/in/abhijit-rabidas', color: 'text-blue-500 hover:text-blue-400' },
                { icon: 'github', url: 'https://github.com/Abhijit-Rabidas', color: 'text-gray-300 hover:text-white' },
                { icon: 'instagram', url: 'https://www.instagram.com/aj_das_01', color: 'text-pink-500 hover:text-pink-400' },
                { icon: 'twitter', url: '#', color: 'text-blue-400 hover:text-blue-300' },
                { icon: 'facebook-f', url: '#', color: 'text-blue-600 hover:text-blue-500' },
              ].map((social, index) => (
                <a
                  key={index}
                  href={social.url}
