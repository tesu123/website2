...
//         <li>Project 2: A mobile app for tracking fitness goals.</li>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {filteredProjects.map((project, index) => (
            <article
              key={index}
              className="group relative bg-white dark:bg-gray-800 rounded-2xl shadow-lg overflow-hidden transition-all duration-500 hover:shadow-xl hover:-translate-y-2"
              ...
              <div className="p-6">
                ...
                <div className="flex space-x-3 mt-4">
                  <a
                    ...
                    className="flex items-center justify-center px-4 py-2 text-sm font-medium rounded-lg bg-gray-100 dark:bg-gray-700 text-gray-800 dark:text-gray-200 hover:bg-gray-200 dark:hover:bg-gray-600 transition-all duration-300 group/github"
                    aria-label={`View code for ${project.title} on GitHub`}
                  >
                    <FaGithub className="mr-2 group-hover/github:text-gray-900 dark:group-hover/github:text-white transition-colors duration-300" />
                    Code
                  </a>
                  <a
                    href={project.demo}
        ...
        <div className="text-center mt-12">
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center px-6 py-3 border border-transparent text-base font-medium rounded-lg shadow-lg text-white bg-gradient-to-r from-emerald-500 to-teal-600 hover:from-emerald-600 hover:to-teal-700 transition-all duration-500 hover:shadow-xl hover:-translate-y-1 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-emerald-500"
